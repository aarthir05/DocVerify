...
from .views import signup_view, upload_document, list_documents, verify_document, delete_document, view_file
...
urlpatterns = [
    ...
    path('api/view/<int:doc_id>/', view_file, name='view_file'),
